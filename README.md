...
## 1. Introduction
This project proposes the design and algorithm of a robot that automates a food storage warehouse, minimizing human intervention. The system focuses on **task scheduling, navigation, and material handling** within defined operational zones.
...
## Working & Operation Envelopes

Hierarchical Diagram
flowchart TD
    A[Warehouse Floor<br>(Working Area)] --> B[Robot Reachable Space<br>(Working Envelope)]
    B --> C[Effective Task Zone<br>(Operation Envelope)]
    A -.-> D[Unreachable Corners / Blocked Shelves<br>(Dead Zone)]
